...
var elegio = ["Accesibilidad","CHOCOLATE","DIENTE","FLIP","AGUA","COMPUTADORA","TELEVISOR","MAQUINA","CELULAR","PILA","TABLA"];

	var rando= Math.floor(Number(Math.random() * elegio.length) + 1);
	
var palabra=elegio[rando];
...
function iniciar () 
{
    ...
    var b = document.getElementById("aprietame");
    ...
    b.addEventListener("click", verificarLetra);
...
function verificarLetra()
{
    ...
    if(y>1 || y==''){
    	...
    	alert("agregar una letra almenos");
    	l.value = "";
    }
    else 
    {
